  ...
  <tr>
    <td width="60%" valign="top">
      <h2>
        ...
        System Profile: User Identity
      </h2>
      <blockquote>
        <p>Terminal logged in... Hello World!</p>
      </blockquote>
      <ul>
        <li>🎓 <b>Who am I:</b> I am an Electronics & Communication Engineering (ECE) student from India.</li>
        <li>💡 <b>What I do:</b> Passionate about <b>Embedded Systems, AI, Robotics, IoT, and Software Development</b>.</li>
        <li>🔧 <b>My Philosophy:</b> I strongly believe in <i>learning by building</i>. Theory is great, but creating real-world engineering projects is where the true magic happens.</li>
        <li>🚀 <b>Long-Term Goal:</b> To build innovative technology products, merge hardware with artificial intelligence, and scale my startup vision.</li>
        <li>🌟 <b>Motto:</b> <i>Dream. Build. Learn. Repeat.</i></li>
      </ul>
    </td>
...
<table align="center" width="100%">
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      <p><b>Focus:</b> Advanced Microcontrollers (ESP32, Arduino), Custom PCB Design, IoT Automation, and Robotics Integration.</p>
      <p><b>Philosophy:</b> Knowledge grows when shared. I am committed to an open-source philosophy, ensuring my schematics, codebases, and logic are accessible to the community.</p>
    </td>
  </tr>
</table>
...
<!-- ===== TECH STACK SECTION ===== -->
<h2 align="center">
  <img src="https://media.giphy.com/media/3oKIPnA2MCKkY0kE5O/giphy.gif" width="30" alt="Tech" /> 
  Tech Stack & Arsenal 
  <img src="https://media.giphy.com/media/3oKIPnA2MCKkY0kE5O/giphy.gif" width="30" alt="Tech" />
</h2>
...
<table align="center" width="100%" style="text-align: center;">
  ...
  <tr>
    <td width="25%">
      <h3>💻 Languages</h3>
      <br>
      <img src="https://skillicons.dev/icons?i=python,c,cpp" theme="dark" /><br><br>
  ...
  <tr>
    <td width="25%">
      <h3>🛠️ Tools</h3>
      <br>
      <img src="https://skillicons.dev/icons?i=vscode,postman,docker" theme="dark" />
    </td>
    <td width="25%">
      <h3>🎨 Design</h3>
      <br>
...
<h2 align="center">🚀 Active Deployments & Projects</h2>

<table align="center" width="100%">
  <tr>
    <td width="33%" valign="top">
      <h3 align="center">🚗 VoltPark</h3>
      <p align="center"><i>Smart Parking & Wireless EV Charging</i></p>
      <ul>
        <li>IoT-enabled smart parking management.</li>
    ...
    <td width="33%" valign="top">
      ...
      <p align="center"><i>Microcontroller Prototyping</i></p>
      <ul>
        <li>Audio amplifier circuits (BC548).</li>
    ...
    <td width="33%" valign="top">
      ...
      <p align="center"><i>Autonomous Systems</i></p>
      <ul>
...
<table align="center" width="100%">
  <tr>
    <td width="50%" valign="top">
      <h3>🛣️ Roadmap</h3>
      <ul>
        <li>🟢 <b>Embedded Systems:</b> Mastering RTOS, ARM Cortex-M, and low-level C programming.</li>
    ...
    <td width="50%" valign="top">
      ...
      <blockquote>
        <p>📖 <b>Learning:</b> Engaged in advanced ECE coursework, Digital Electronics, and NPTEL Python modules.</p>
        <p>🛠️ <b>Building:</b> Transitioning breadboard prototypes to custom-printed PCBs.</p>
        <p>🧪 <b>Experimenting:</b> Combining AI vision models with ESP32-CAM modules.</p>
        <p>🌐 <b>Open Source:</b> Contributing to hardware libraries and creating detailed documentation.</p>
        <p>💼 <b>Entrepreneurship:</b> Learning product management, UI/UX for hardware interfaces, and market dynamics.</p>
      </blockquote>
    </td>
  </tr>
</table>
...
<!-- ===== GITHUB ANALYTICS ===== -->
<h2 align="center">
  <img src="https://media.giphy.com/media/cj87CxfRtrU7u/giphy.gif" width="30" alt="Graph" /> 
